...
type BOOL = LibC::Int32
type BOOLEAN = LibC::Byte
type BSTR = LibC::Char*
type HANDLE = LibC::Int*
type HINSTANCE = LibC::Int*
type HRESULT = LibC::Int32
type HWND = LibC::Int*
type LPARAM = LibC::Int*
type LRESULT = LibC::Int*
type LSTATUS = LibC::Int32
type NTSTATUS = LibC::Int32
type PSID = LibC::Int*
type PSTR = LibC::Byte*
type PWSTR = LibC::Char*
type WPARAM = LibC::UIint*
type HRSRC = LibC::Int*
type CHAR = LibC::Byte
type SHANDLE_PTR = LibC::Int*
type HANDLE_PTR = LibC::UIint*
struct SYSTEMTIME
  wYear : LibC::UInt16
  wMonth : LibC::UInt16
...
struct FILETIME
  dwLowDateTime : LibC::UInt32
  dwHighDateTime : LibC::UInt32
end
struct HUMPD__
  unused : LibC::Int32
end
...
fun sysFreeString(bstrString : BSTR) : LibC::Void
fun sysStringLen(pbstr : BSTR) : LibC::UInt32
fun sysStringByteLen(bstr : BSTR) : LibC::UInt32
fun sysAllocStringByteLen(psz : PSTR, len : LibC::UInt32) : BSTR
fun closeHandle(hObject : HANDLE) : BOOL
fun duplicateHandle(hSourceProcessHandle : HANDLE, hSourceHandle : HANDLE, hTargetProcessHandle : HANDLE, lpTargetHandle : HANDLE*, dwDesiredAccess : LibC::UInt32, bInheritHandle : BOOL, dwOptions : DUPLICATE_HANDLE_OPTIONS) : BOOL
fun compareObjectHandles(hFirstObjectHandle : HANDLE, hSecondObjectHandle : HANDLE) : BOOL
fun getHandleInformation(hObject : HANDLE, lpdwFlags : LibC::UInt32*) : BOOL
fun setHandleInformation(hObject : HANDLE, dwMask : LibC::UInt32, dwFlags : HANDLE_FLAGS) : BOOL
fun getLastError() : WIN32_ERROR
fun setLastError(dwErrCode : WIN32_ERROR) : LibC::Void
fun setLastErrorEx(dwErrCode : WIN32_ERROR, dwType : LibC::UInt32) : LibC::Void
fun rtlNtStatusToDosError(status : NTSTATUS) : LibC::UInt32
